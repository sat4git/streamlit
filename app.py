...
gb.configure_column('virtual column a + b', valueGetter='Number(df.age) * Number(2)', cellRenderer='agAnimateShowChangeCellRenderer', editable='false', type=['numericColumn'])
go = gb.build()
